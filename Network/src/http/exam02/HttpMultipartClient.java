...
public class HttpMultipartClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HttpPost httpPost = new HttpPost("http://192.168.3.117:8080/IoTWebProgramming/http/exam02");
        MultipartEntityBuilder multipartEntityBuilder = MultipartEntityBuilder.create();
        //문자 파트
        multipartEntityBuilder.addPart("title", titleBody);
        multipartEntityBuilder.addPart("content", contentBody);
        //파일 파트
        multipartEntityBuilder.setCharset(Charset.forName("UTF-8")); //파일 이름에 한글이 포함되어 있을 경우
