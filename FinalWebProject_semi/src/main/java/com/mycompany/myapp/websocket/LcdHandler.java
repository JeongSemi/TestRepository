...
@Component
public class LcdHandler extends TextWebSocketHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(LcdHandler.class);
			...
			public void run() {
				while (true) {
					try {
						...
						jsonObject.put("lcdline0", Classify.lcdline0);
						jsonObject.put("lcdline1", Classify.lcdline1);
