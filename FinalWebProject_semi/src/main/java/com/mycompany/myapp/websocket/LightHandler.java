...
@Component
public class LightHandler extends TextWebSocketHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(LightHandler.class);
			...
			public void run() {
				while (true) {
					try {
						...
						jsonObject.put("light", Classify.light);
