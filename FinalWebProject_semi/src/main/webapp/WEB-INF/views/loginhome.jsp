						    	...
						    	<div>
							        <table id="sensorTable">
								        ...
								        <tr>
										    ...
										    <td><input type="number" id="temperature" name="temperature" value="${temperature }"></td>
										</tr>
										<tr>
										    <td>기압(Pressure)</td>
										    <td><input type="number" id="pressure" name="pressure" value="${pressure }"></td>
										</tr>
										<tr>
										    <td>습도(Humiture)</td>
										    <td><input type="number" id="humiture" name="humiture" value="${humiture }"></td>
										</tr>
										<tr>
										    <td>조도(Photoresistor)</td>
										    <td><input type="number" id="photoresistor" name="photoresistor" value="${photoresistor }"></td>
										</tr>
										<tr>
										    <td>빗물(Raindrop)</td>
										    <td><input type="number" id="raindrop" name="raindrop" value="${raindrop }"></td>
										</tr>
										<tr>
										    <td>가스(gas)</td>
										    <td><input type="number" id="gas" name="gas" value="${gas }"></td>
										</tr>
										<tr>
										    <td>기울기(Mercury)</td>
										    <td> <c:set var="mercury" value="${mercury }"/>
										    	<c:if test="${mercury eq 1}">
										    		<input type="radio" name="mercury" value="1" checked> HIGH &nbsp;
										    		<input type="radio" name="mercury" value="0"> LOW
										    	</c:if>
										    	<c:if test="${mercury eq 0}">
										...
										<tr>
										    <td>초음파(Ultrasonic)-왼쪽/전방</td>
										    <td><input type="number" id="frontLeftUltrasonic" name="flultrasonic" value="${frontLeftUltrasonic }"></td>
										</tr>
										<tr>
										    <td>초음파(Ultrasonic)-오른쪽/전방</td>
										    <td><input type="number" id="frontRightUltrasonic" name="frultrasonic" value="${frontRightUltrasonic }"></td>
										</tr>
										<tr>
										    <td>초음파(Ultrasonic)-왼쪽/측면</td>
										    <td><input type="number" id="sideLeftUltrasonic" name="slultrasonic" value="${sideLeftUltrasonic }"></td>
										</tr>
										<tr>
										    <td>초음파(Ultrasonic)-오른쪽/측면</td>
										    <td><input type="number" id="sideRightUltrasonic" name="srultrasonic" value="${sideRightUltrasonic }"></td>
										</tr>
										<tr>
										    <td>초음파(Ultrasonic)-후방</td>
										    <td><input type="number" id="backUltrasonic" name="backultrasonic" value="${backUltrasonic }"></td>
										</tr>
							        </table>
						    	</div>
