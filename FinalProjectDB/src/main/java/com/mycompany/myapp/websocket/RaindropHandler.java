...
import com.mycompany.myapp.dto.Raindrop;
import com.mycompany.myapp.dto.Temperature;
import com.mycompany.myapp.service.SensorService;

@Component
public class RaindropHandler extends TextWebSocketHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(RaindropHandler.class);
	...
	public void init() throws Exception {
		...
		mqttCallback = new MqttCallback() {
			...
			public void messageArrived(String string, MqttMessage mm) throws Exception {
				...
				if ((jsonObject.getString("command")).equals("raindrop")) {
					System.out.println("*RaindropHandler*messageArrived: " + subJson);
					rainValue = jsonObject.getDouble("value");

					Raindrop raindrop = new Raindrop();
					raindrop.setRainvalue(rainValue);
