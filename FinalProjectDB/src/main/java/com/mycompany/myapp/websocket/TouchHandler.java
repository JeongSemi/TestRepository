...
@Component
public class TouchHandler extends TextWebSocketHandler {
	...
	public void init() throws Exception {
		...
		mqttCallback = new MqttCallback() {
			...
			public void messageArrived(String string, MqttMessage mm) throws Exception {
				...
				if ((jsonObject.getString("command")).equals("touch")) {
					System.out.println("*TouchHandler*messageArrived: " + subJson);
