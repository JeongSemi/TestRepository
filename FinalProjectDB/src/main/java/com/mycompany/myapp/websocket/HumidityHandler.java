...
@Component
public class HumidityHandler extends TextWebSocketHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(HumidityHandler.class);
	...
	public void init() throws Exception {
		...
		mqttCallback = new MqttCallback() {
			...
			public void messageArrived(String string, MqttMessage mm) throws Exception {
				...
				if ((jsonObject.getString("command")).equals("humidity")) {
					System.out.println("*HumidityHandler*messageArrived: " + subJson);
					hum = jsonObject.getDouble("value");
