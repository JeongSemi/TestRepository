...
@Component
public class PressureHandler extends TextWebSocketHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(PressureHandler.class);
	...
	public void init() throws Exception {
		...
		mqttCallback = new MqttCallback() {
			...
			public void messageArrived(String string, MqttMessage mm) throws Exception {
				...
				if ((jsonObject.getString("command")).equals("pressure")) {
					System.out.println("*PressureHandler*messageArrived: " + subJson);
					pressureValue = jsonObject.getDouble("value");
