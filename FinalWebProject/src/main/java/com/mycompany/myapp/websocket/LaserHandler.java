...
@Component
public class LaserHandler extends TextWebSocketHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(LaserHandler.class);
			...
			public void run() {
				while (true) {
					try {
						...
						jsonObject.put("laser", Classify.laser);
