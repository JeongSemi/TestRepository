...
@Component
public class CameraHandler extends TextWebSocketHandler {
			...
			public void run() {
				while (true) {
					try {
						...
						jsonObject.put("cameraUpdown", Classify.cameraUpdown);
						jsonObject.put("cameraLeftRight", Classify.cameraLeftright);
